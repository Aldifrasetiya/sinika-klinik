      ...
      <ul class="nav nav-primary">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="base">
            <ul class="nav nav-collapse">
              <li>
                <a href="./../pages/content/owner/m_data_pasien">
                  <span class="sub-item">Data Pasien</span>
                </a>
              </li>
              <li>
                <a href="./../pages/content/owner/m_data_user">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="sidebarLayouts">
            <ul class="nav nav-collapse">
              <li>
                <a href="./../pages/content/owner/m_dokter_umum">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="obat">
            <ul class="nav nav-collapse">
              <li>
                <a href="./../pages/content/owner/m_data_obat">
