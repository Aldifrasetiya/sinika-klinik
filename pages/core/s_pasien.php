      ...
      <ul class="nav nav-primary">
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="base">
            <ul class="nav nav-collapse">
              <li>
                <a href="p_pendaftaran_antrian.php">
                  <span class="sub-item">Pendaftaran</span>
                </a>
              </li>
              <li>
                <a href="data-antrian.html">
                  <span class="sub-item">Jadwal Antrian</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="obat">
            <ul class="nav nav-collapse">
              <li>
                <a href="p_bayar_obat.php">
                  <span class="sub-item">Pembayaran Obat</span>
                </a>
              </li>
            </ul>
          </div>
